...
namespace GielinorAdventures.Models
{
    ...
    public class Mob
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating how long it takes for this <see cref="Mob"/> to respawn.
        /// </summary>
        /// <value>The respawn time.</value>
        public int RespawnTime { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Mob"/> is attackable.
        /// </summary>
        /// <value><c>true</c> if it is attackable; otherwise, <c>false</c>.</value>
        public bool IsAttackable { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Mob"/> is aggressive.
        /// </summary>
        ...
        public virtual int CombatLevel
        {
            get
            {
                double baseLevel = 0.25 * (DefenceLevel + HitpointsLevel);
                double meleeLevel = 0.325 * (AttackLevel + StrengthLevel);
                double rangedMagicLevel = 0.325 * Math.Floor(Math.Max(RangedLevel, MagicLevel) * 1.5);
